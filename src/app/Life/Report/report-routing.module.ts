...
export const reportRoutes: Routes = [
  { path: '', redirectTo: appRoutes.life.report.index._, pathMatch: 'full' },
  {
    path: 'batch',
    loadChildren: () =>
      import(
  ...
  {
    path: appRoutes.life.report.index._,
    loadChildren: () =>
      import(
        '../../Life/Report/report-pages/life-report-index/life-report-index.module'
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        '../../Life/Report/report-pages/life-report-create/life-report-create.module'
  ...
  },
  {
    ...
    data: { title: 'Edit', type: EPageType.editPage },
  },
  {
    path: 'clone',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        '../../Life/Report/report-pages/visualize-report/visualize-report.module'
  ...
  },
  {
    path: 'table',
    loadChildren: () =>
      import('./report-pages/report-table/report-table.module').then(
        (m) => m.ReportTableModule
      ),
    data: { title: 'Screen View' },
  },
];
