...
export class CreateCorrespondenceWebhook
  ...
  implements OnInit
{
      ...
      this.correspondenceService
        ...
        .subscribe(
          (data: CreateCorrespondence) => {
            ...
            this.util.info(
              `Correspondence Webhook ${data.correspondence.code} has been saved successfully!.`,
              1
            );
  ...
  removeCorrespondenceDocLink(i: number) {
    if (confirm('Do you want to delete this Correspondence Document Link?')) {
        ...
        this.correspondenceService
          ...
          .subscribe(
            (data: any) => {
              ...
              this.util.notify('Correspondence Filter deleted suceesfully.', 1);
            },
            () => {
