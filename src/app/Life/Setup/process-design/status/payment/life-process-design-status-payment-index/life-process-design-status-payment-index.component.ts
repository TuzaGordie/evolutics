...
@Component({
  selector: 'app-life-process-design-status-payment-index',
  templateUrl: './life-process-design-status-payment-index.component.html',
  styleUrls: ['./life-process-design-status-payment-index.component.scss'],
})
export class LifeProcessDesignStatusPaymentIndexComponent implements OnInit {
  companies: any[] = [];
  statusCodes: any[] = [];
  ...
  getStatusCodeByCompanyAndCat() {
    this.codeService
      .getStatusCodeByCompanyAndCat('PO', this.company)
      .subscribe((data: any) => {
