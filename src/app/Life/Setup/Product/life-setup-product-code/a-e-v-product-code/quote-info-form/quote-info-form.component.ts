...
@Component({
  selector: 'app-quote-info-form',
  templateUrl: './quote-info-form.component.html',
  styleUrls: ['./quote-info-form.component.scss'],
})
export class QuoteInfoFormComponent implements OnInit {
