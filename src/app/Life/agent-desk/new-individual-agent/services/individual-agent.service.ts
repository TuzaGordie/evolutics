...
import { IAgentCreationResponse } from 'src/app/Shared/models/agent.interface';
...
export class IndividualAgentService {
  ...
  getBranchList() {
    return this.apiService.get(this.baseAPIURL + '/rest/branch/code/desc');
  }
  getCompanyList() {
    return this.apiService.getCodes<ICodeDescription>(
      this.baseAPIURL + '/rest/company/code/desc'
    );
  }
  getCountryList() {
  ...
  getBanknameList(country: any) {
    return this.apiService.get(this.baseAPIURL + '/rest/bank/code/desc/' + country);
  }
  ...
  submitPostData(data: any) {
    ...
    return this.apiService.postFile<IAgentCreationResponse>(
      this.baseAPIURL + '/rest/agent',
      data
    );
  }
  ...
  getClientBankAccounts(clientNo: string) {
    return this.apiService.get<IAccount[]>(
      this.baseAPIURL + '/rest/client/existing/accounts/' + clientNo
    );
  }
}
