...
} from 'src/app/Shared/models/life/setup/correspondence/CreateCorrespondence';import {Router} from "@angular/router"; 
...
@Component({
  selector: 'app-crmcorrespondence-quotation-create',
  templateUrl: './crmcorrespondence-quotation-create.component.html',
  styleUrls: ['./crmcorrespondence-quotation-create.component.scss']
})
export class CRMCorrespondenceQuotationCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createCorrespondence.correspondence.code = localStorage.getItem('correspondence_document_code_quotation');
