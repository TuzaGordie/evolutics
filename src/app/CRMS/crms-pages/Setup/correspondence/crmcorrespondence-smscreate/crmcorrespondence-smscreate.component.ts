...
@Component({
  selector: 'app-crmcorrespondence-smscreate',
  templateUrl: './crmcorrespondence-smscreate.component.html',
  styleUrls: ['./crmcorrespondence-smscreate.component.scss']
})
export class CRMCorrespondenceSMSCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createCorrespondence.correspondence.code = localStorage.getItem('correspondence_document_code_sms');
