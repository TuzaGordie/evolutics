...
@Component({
  selector: 'app-crmcorrespondence-webhook-create',
  templateUrl: './crmcorrespondence-webhook-create.component.html',
  styleUrls: ['./crmcorrespondence-webhook-create.component.scss']
})
export class CRMCorrespondenceWebhookCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createCorrespondence.correspondence.code = localStorage.getItem('correspondence_document_code_webhook');
