...
@Component({
  selector: 'app-crmcorrespondence-print-create',
  templateUrl: './crmcorrespondence-print-create.component.html',
  styleUrls: ['./crmcorrespondence-print-create.component.scss']
})
export class CRMCorrespondencePrintCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createCorrespondence.correspondence.code = localStorage.getItem('correspondence_document_code_print');
