...
@Component({
  selector: 'app-crmindividual-agent-index',
  templateUrl: './crmindividual-agent-index.component.html',
  styleUrls: ['./crmindividual-agent-index.component.scss']
})
export class CRMIndividualAgentIndexComponent implements OnInit {
