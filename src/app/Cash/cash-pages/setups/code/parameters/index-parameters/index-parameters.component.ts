...
export class CashIndexParametersComponent implements OnInit {
  allCodes: any[] = [];
  allCodeGroups: any[] = [];
  ...
  createSubGroup() {
    this.router.navigateByUrl('/cash/code/create-subgroup-parameters');
  }

  createGroup() {
    this.router.navigateByUrl('/cash/code/create-parameters');
  }
