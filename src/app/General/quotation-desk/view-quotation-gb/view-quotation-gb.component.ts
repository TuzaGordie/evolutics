...
@Component({
  selector: 'app-view-quotation-gb',
  templateUrl: './view-quotation-gb.component.html',
  styleUrls: ['./view-quotation-gb.component.scss']
})
export class ViewQuotationGBComponent implements OnInit {
